...
export default function SideBar() {
  ...
  const linkClasses = (path) => {
    let baseClasses = "font-normal hover:font-bold dark:bg-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-md px-3 py-2 transition-colors duration-300";
    if (pathname === path) {
